...
const PILARES = [
  ...
  },
  {
    ...
    subtitulo: "Prevenção geracional",
    descricao: "Todos os apps reagem DEPOIS da violência. O Legado ataca a RAIZ: educa a próxima geração com parentalidade consciente e inteligência emocional. O ciclo acaba aqui.",
  ...
  },
  {
    icon: Briefcase,
    tag: "EXCLUSIVO",
    titulo: "Vagas Blindadas",
    subtitulo: "Independência financeira",
    descricao: "75% das mulheres voltam ao agressor por dependência financeira. O Legado conecta com empresas verificadas que oferecem emprego seguro, sigiloso e sem julgamento.",
    stat: "Empresas verificadas",
    cor: "sky",
  },
];
